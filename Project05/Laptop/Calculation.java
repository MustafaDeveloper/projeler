...
public class Calculation {
     ...
     */
     ...
     /*
        ...
        Not price -- fiyat
     */
    int getRam(ArrayList<String> array){
        String str=array.get(2);
        int price=0;
        if(str.contains("32 gb")) price= 300;
        if(str.contains("16 gb")) price= 200;
        if(str.contains("8 gb"))  price= 100;
        if(str.contains("4 gb")) price= 50;
        return price;
    }
    ...
    int getCPU(ArrayList<String> array){
   ...
   */
     ...
     */
     int getColor(ArrayList<String> array){
         String str=array.get(4);
         int price=0;
         if(str.contains("Red")){
             price=400;
   ...
   */
    ...
    int getSize(ArrayList<String> array){
